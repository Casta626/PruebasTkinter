...
class Aplicacion(ttk.Frame):
    def __init__(self, parent):
        ...
        self.boton_convertir = ttk.Button( text="Convertir", 
        command=self.convertir_temp, style='W.TButton')
        self.etiqueta_temp_celsius.bind('<Return>', self.convertir_temp)
        self.boton_convertir.config(command=self.convertir_temp)
